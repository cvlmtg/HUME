...
pub(crate) fn register_all(steel: &mut Engine) {
    ...
    builtins! { steel,
        ...
        cmd "%completion-begin!" completion::completion_begin(bid: args::BidArg, items: SteelVal, incomplete: SteelVal, source: SteelVal, priority: SteelVal);
        cmd "%completion-add-items!" completion::completion_add_items(token: SteelVal, items: SteelVal, source: SteelVal, priority: SteelVal, incomplete: SteelVal);

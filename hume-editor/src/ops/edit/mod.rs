...
pub(crate) use align::align_selections;
pub(crate) use case::{make_text_capitalized, make_text_lowercase, make_text_uppercase};
...
pub(crate) use join::join_lines_select_spaces;
pub(crate) use paste::{paste_after, paste_before};

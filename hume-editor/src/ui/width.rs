...
pub(in crate::ui) const ELLIPSIS: &str = "…";
...
pub(in crate::ui) const ELLIPSIS_WIDTH: usize = 1;
...
pub(in crate::ui) fn cell_width(g: &str) -> usize {
...
/// computed.
pub(in crate::ui) fn truncate_text(s: &str, max_display_width: usize) -> (&str, usize) {
...
/// splits a cluster.
pub(in crate::ui) fn truncate_text_tail(s: &str, max_display_width: usize) -> (&str, usize) {

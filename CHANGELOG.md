...
- New `set-line-backgrounds!` scripting builtin sets a full-line background tint, the same `(set-X! source bid entries)` shape as the other decoration setters.

...
- M1 core engine in progress. Completed: Buffer, Selection, ChangeSet, Transaction, edit operations, motions, text objects, undo/redo (tree-structured).

...
/// See [`hume_rope::place_display_column`].
pub fn place_display_column(buf: &Text, line: usize, target_col: usize, tab_width: u8) -> usize {
    hume_rope::place_display_column(buf.rope(), line, target_col, tab_width)
}

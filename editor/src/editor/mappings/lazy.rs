...
impl Editor {
    ...
    /// report triple.
    pub(super) fn activate_and_register(&mut self, plugin: &scripting::attribution::PluginId) {
    ...
    pub(in super::super) fn activate_lazy_event_plugins(
        &mut self,
        hook_id: scripting::hooks::HookId,
    ) {
    ...
    fn activate_pending_plugins(
        &mut self,
        pending: Vec<scripting::attribution::PluginId>,
        trigger: &str,
    ) {
